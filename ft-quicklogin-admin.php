...
function fql_admin_init() {
	//Load the Uploadify
	wp_enqueue_script( 'jquery-uploadify', plugins_url('uploadify/jquery.uploadify.js', FQL_FILE), array('jquery', 'swfobject'), null );
}
				...
				<label for="fql_upload_image">
					...
					jQuery(document).ready(function(){
						...
						jQuery('#fql_upload_image_file').uploadify({
							'uploader'  : '<?php echo plugins_url('uploadify/uploadify.swf', FQL_FILE); ?>',
							'script'    : '<?php echo plugins_url('uploadify/uploadify.php', FQL_FILE); ?>',
							'cancelImg' : '<?php echo plugins_url('uploadify/cancel.png', FQL_FILE); ?>',
							'buttonImg' : '<?php echo plugins_url('uploadify/button.jpg', FQL_FILE); ?>',
